...
validate_staging_queries = [staging_events_rows, staging_songs_rows]
validate_insert_queries = [songplay_rows, users_rows, song_rows, artist_rows, time_rows]